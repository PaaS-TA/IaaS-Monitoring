...
func GetManageNodeService(openstackProvider models.OpenstackProvider, provider *gophercloud.ProviderClient,influxClient client.Client) *ManageNodeService {
...
func (n ManageNodeService) GetTopProcessListByCpu(request models.DetailReq)(result []models.TopProcess, _ models.ErrMessage){

	var topProcessList []models.TopProcess
	...
	if err != nil {
		...
		for _, value := range topProcessResult{
			...
			for _, vv := range aa{
				processData := map[float64]string{utils.TypeChecker_float64(vv["usage"]).(float64):
				                   utils.TypeChecker_string(vv["process_name"]).(string)}
		...
		for idx := range usageArr{
			...
			for _ , v := range usage{
				if v[usageArr[idx]] != ""{
					...
					var topProcess models.TopProcess
...
//CPU Top Process List
func (n ManageNodeService) GetTopProcessListByMemory(request models.DetailReq)(result []models.TopProcess, _ models.ErrMessage){
...
func (n ManageNodeService) GetRabbitMqSummary()(result models.RabbitMQGlobalResource, err models.ErrMessage){
...
func (n ManageNodeService) GetManageNodeSummary(apiRequest models.NodeReq)([]models.ManageNodeResources, models.ErrMessage){

	manageNodeNameList := getManageNodeName(n.openstackProvider, n.provider, n.influxClient)

	var manageNodeList []models.ManageNodeResources
	...
	for _, hostname := range manageNodeNameList{
		...
		var manageNodeResource models.ManageNodeResources
...
func getManageNodeName(opts models.OpenstackProvider, provider *gophercloud.ProviderClient ,client client.Client)([]string){
...
func  getManageNodeSummary_Sub(request models.NodeReq, f client.Client) (map[string]interface{}, map[string]interface{}, map[string]interface{},
		map[string]interface{}, map[string]interface{}, map[string]interface{}, map[string]interface{}, models.ErrMessage) {
