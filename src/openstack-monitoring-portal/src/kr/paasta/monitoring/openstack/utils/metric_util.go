...
func (r clientResponse) InfluxConverterList(resp client.Response, name string) (map[string]interface{}, models.ErrMessage){
...
//조회한 결과List를 Map으로 변환한다.
func (r clientResponse) InfluxConverter(resp client.Response) (map[string]interface{}, models.ErrMessage){
...
//조회한 결과를 Map으로 변환한다.
func (r clientResponse) InfluxConverter4Usage(resp client.Response, name string) (map[string]interface{}, models.ErrMessage){
...
//조회한 결과List를 Map으로 변환한다.
func (r clientResponse) InfluxConverterToMap(resp client.Response) ([]map[string]interface{}, models.ErrMessage){
...
func (r clientResponse) GetMountPointList(resp client.Response) ([]string, models.ErrMessage){
...
//조회한 결과List를 Map으로 변환한다.
func (r clientResponse) InfluxConverter4TopProcess(resp client.Response) (map[string]interface{}, models.ErrMessage){
