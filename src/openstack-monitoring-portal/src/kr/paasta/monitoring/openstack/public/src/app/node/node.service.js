(function() {
  ...
  function ComputeNodeService($http, apiUris, common) {
    ...
    service.computeTopProcessByCpu = function(condition) {
      return $http.get(apiUris.computeTopProcessByCpu.replace(":hostname", condition.hostname));
    };

    service.computeTopProcessByMemory = function(condition) {
      return $http.get(apiUris.computeTopProcessByMemory.replace(":hostname", condition.hostname));
    };
