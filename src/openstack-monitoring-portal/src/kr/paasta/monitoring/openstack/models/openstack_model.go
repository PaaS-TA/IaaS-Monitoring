...
type(
	/**
	Description : Openstack Admin Information to Get Openstack's Resources - ex: Hypervisor, Node, Project
	 */
	...
	/**
	Description : Openstack project struct
	 */
	ProjectInfo 	struct{
		ParentId 		string 		`json:"projectId"`
	...
	/**
	Description: Openstack project resources usage including limit medatada
	 */
	ProjectResourcesUsage struct{
		Instances 		int 		`json:"instances"`
		Vcpus 			float64 	`json:"vcpus"`
		MemoryMb 		float64 	`json:"memory_mb"`
		SecurityGroups		int 		`json:"security_groups"`
		FloatingIps 		int 		`json:"floating_ips"`
		ProjectResourceLimit 	ProjectResourcesLimit
		ProjectNetworkLimit 	ProjectNetworkLimit
		ProjectStorageResource  ProjectStorageResources
	}

	/**
	Description: Openstack project resources limit metadata
	 */
	ProjectResourcesLimit struct{
		/*
	...
	/**
	Description: Openstack project storage limit metadata
	 */
	ProjectStorageResources struct {
		/*
	...
	/**
	Description: Openstack project network limit metadata
	 */
	ProjectNetworkLimit struct{
		/*
	...
	/**
	Description: Openstack project's created instance info
	 */
	InstanceInfo 	struct{
	...
	/**
	Description: Project Floating IP Information
	 */
