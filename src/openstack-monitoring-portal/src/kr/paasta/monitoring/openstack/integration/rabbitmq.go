...
func GetRabbitMq(openstack_provider models.OpenstackProvider) *RabbitMq {
	return &RabbitMq{
...
func (r *RabbitMq) GetRabbitMQOverview() (rabbitmq_overview models.RabbitMQGlobalResource, err error) {
	...
	overview_url := fmt.Sprintf("http://%s:%s@%s:%s/api/overview", r.OpenstackProvider.RabbitmqUser, r.OpenstackProvider.RabbitmqPass, models.RabbitMqIp, models.RabbitMqPort)
	...
	var rabbitmq_node_resources models.RabbitMQNodeResources
	overview_url = fmt.Sprintf("http://%s:%s@%s:%s/api/nodes/%s", r.OpenstackProvider.RabbitmqUser, r.OpenstackProvider.RabbitmqPass, models.RabbitMqIp, models.RabbitMqPort,r.OpenstackProvider.RabbitmqTargetNode)
